...
class DebitOrCreditView extends StatefulWidget {
  @override
  _DebitOrCreditViewState createState() => _DebitOrCreditViewState();
}

class _DebitOrCreditViewState extends State<DebitOrCreditView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(TranslatedMessages.general['debit_or_credit']),
        actions: [
          IconButton(
              icon: Icon(
                Icons.refresh,
