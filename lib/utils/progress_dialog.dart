      ...
      showDialog<dynamic>(
        ...
        builder: (BuildContext context) {
          ...
          return Dialog(
              ...
              backgroundColor: FelsmaxColors.whiteColor,
    ...
    return WillPopScope(
      ...
      child: SizedBox(
          ...
          child: Row(children: <Widget>[
            ...
            SizedBox(
              width: 50.0,
              child: Image.asset(AssetPath.loader),
            ),
            const SizedBox(width: 15.0),
            Expanded(
              child: _progressDialogType == ProgressDialogType.Normal
                  ? Text(_dialogMessage,
                      style: FelsmaxTextStyles.display21Style
                      ...
                      children: <Widget>[
                        Positioned(
                          child: Text(_dialogMessage,
                              style:
                                  FelsmaxTextStyles.contentTextTextStyleCard),
                          top: 35.0,
                        ),
                        Positioned(
